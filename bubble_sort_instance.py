...
def sort(numbers):
    ...
    """
    for index_num in range(len(numbers)-1,0,-1):
        for posi_num in range(index_num):
            if numbers[posi_num] > numbers[posi_num + 1]:
                numbers[posi_num], numbers[posi_num + 1] = numbers[posi_num + 1],numbers[posi_num]
